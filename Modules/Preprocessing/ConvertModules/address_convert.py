...
def load_dvhc_json(file_name) -> dict:
    with open(json_path + file_name, "r", encoding="utf-8") as dvhc_file:
        dvhc_json = json.load(dvhc_file)
    return dvhc_json

_dvhc_json_2020 = load_dvhc_json("dvhcvn_2020.json")
_dvhc_json_2024 = load_dvhc_json("dvhcvn_2024.json")